...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	...
	<base href="<?=base_url()?>" />
	<link rel="shorcut icon" href="asset/system_img/logo1.png" />
...
<body>
	<?php
		if($this->session->userdata('loginState') == true){
			$this->load->view('backend/ignite_nav');
		}
	?>
	...
	<div class="text-center text-ignite small-padding">Designed & Developed by Ignitesource.</div>
